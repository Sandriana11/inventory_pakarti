                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control {{ $errors->has('nip') ? 'is-invalid' : '' }}"
                                id="field-nip" name="nip" placeholder="Masukan NIP" value="{{ old('nip', $data->nip) }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}"
                                id="field-username" name="username" placeholder="Masukan Username" value="{{ old('username', $data->username) }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control {{ $errors->has('level ') ? 'is-invalid' : '' }}" name="level">
                                ...
                                <option value="admin" {{ (old('level', $data->level) == "admin") ? 'selected="selected"' : '' }}>Admin</option>
                                <option value="pegawai" {{ (old('level', $data->level) == "pegawai") ? 'selected="selected"' : '' }}>Pegawai</option>
                                <option value="eksekutor" {{ (old('level', $data->level) == "eksekutor") ? 'selected="selected"' : '' }}>Eksekutor</option>
                            </select>
