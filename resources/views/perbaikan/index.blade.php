    ...
    <div class="content">
        ...
        <div class="content-heading d-flex justify-content-between align-items-center">
            ...
            <div class="space-x-1">
                ...
                <a href="{{ route('maintenance.create') }}" class="btn btn-sm btn-primary me-1">
    ...
    <div class="modal" id="modal-normal" tabindex="-1" aria-labelledby="modal-normal" style="display: none;"
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('maintenance.export') }}" method="GET" target="_blank">
    ...
    <script type="text/javascript">
        ...
        var table = $('.datatable').DataTable({
            ...
            columns: [
                ...
                {data: 'kerusakan.nomor', name: 'kerusakan.nomor'},

                {data: 'tgl', name: 'tgl'},

                {data: 'eksekutor.name', name: 'eksekutor.name'},
